...
Tuebingen primary colors. The tow themes can be applied to discrete and continuous data by choosing the 
right option in the brackets. 

Note: The themes only work if the number of objects to be colored matches the number of the University of Tuebingen 
colors. 
